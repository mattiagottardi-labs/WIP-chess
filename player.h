...
class Player { // Player only handles game logic, User will do the rest
    ...
    void turn(); // this is the main function that should be called in main, it should call selectPiece, getScope, and move in order, and also check for check and checkmate
};
#endif